...
def main(numToCal, scene_name, qp_values, qn_values, qfd_values, qfr_values, qo_values, qs_values, qr_values, cl_values, qt_values, qg_values):
...
if __name__ == "__main__":
    ...
    main(scene_name, qp_values, qn_values, qfd_values, qfr_values, qo_values, qs_values, qr_values, cl_values, qt_values, qg_values)
